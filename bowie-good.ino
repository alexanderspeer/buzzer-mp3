/*
  Space Oddity – Choir Track
  Passive buzzer player

  Wiring:
    D9 -> 300Ω resistor -> buzzer +
    buzzer - -> GND
*/
...
const uint8_t  EXTRA_GAP_MS = 2;    // small separation between events
const uint16_t LOOP_PAUSE_MS = 2000;
...
void loop() {
  ...
  delay(LOOP_PAUSE_MS);  // pause before repeating
}
